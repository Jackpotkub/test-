...
<?php
    ...
    echo '<tr><td align="left"><a href="index.php">เพิ่มข้อมูลลูกค้า</a></td><tr>';
    echo '</table>';
    ...
    while ($rs = mysqli_fetch_array($result))
    {
        ...
        echo '<td><a href="customerDelete1.php?customerId = '.$rs["customerId"].'" 
        onclick="return confirm(\'ยืนยันการลบข้อมูลลูกค้ารหัส'.$rs["customerId"].'\')">[ลบ]</a></td>';
        echo '</tr>';
